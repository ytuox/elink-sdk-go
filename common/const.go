...
type PluginNotifyType string

const (
	PluginStartNotify PluginNotifyType = "start"
	PluginStopNotify  PluginNotifyType = "stop"
)

type DataDirection int64

const (
	South DataDirection = 0
	North DataDirection = 1
)
